...
def render_tab(df):
    ...
    layout = html.Div([html.H1('Kanały sprzedaży - dni tygodnia',style={'text-align':'center'}),

                        html.Div([html.Div([dcc.Graph(id='other-pie-store-type',figure=fig)],style={'width':'50%'}), 
